...
const ColorPicker = ({selectedColor , onChage}) => {
    const colors = [
        {name : "Blue" , value: "#3B80F6"},
  ...
  return (
    <div className='relative'>
        ...
        bg-linear-to-br from-purple-50 to-purple-100 ring-purple-300 hover:ring
        ...
        {isOpen && (
            ...
            right-0 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm'>
                {colors.map((color)=>(
                    <div key={color.value} className='relative cursor-pointer group flex flex-col' onClick={()=>{onChage(color.value);setIsOpen(false)}}>
