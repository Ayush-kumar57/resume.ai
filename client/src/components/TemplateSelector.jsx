...
const TemplateSelector = ({selectedTemplate ,onChage}) => {
    ...
    const templates =[
        ...
        },
        {
        ...
        },
          {
            id :"minimal-image",
            name :"Minimal Image",
            preview : "Minimal design with a single and clean typography"
        },
          {
            id :"minimal",
            name :"Minimal",
  ...
  return (
    <div className='relative'>
        ...
        bg-linear-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring
            ...
            isOpen && (
                ...
                rounded-md border border-gray-200 shadow-sm'>
                    {templates.map((template)=>(
                        <div key={template.id} onClick={()=>{onChage(template.id);
                            setIsOpen(false)
