  ...
  return (
    ...
    <div>
        <div className='max-w-7xl mx-auto px-4 py-8'>
            <p className='text-2xl font-medium mb-6 bg-gradiant-to-r from-slate-600 to-slate-700
            ...
            <div className='flex gap-4'>
                ...
                border-b-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all
                ...
                justify-center rounded-lg gap-2 text-slate-600 border border-dashed
                border-b-slate-300 group hover:border-purple-500 hover:shadow-lg transition-all
                duration-300 cursor-pointer'>
                    ...
                    return(
                        ...
                        `, borderColor: baseColor + '40'}} >
                            ...
                            hidden'>
                                ...
                                <PencilIcon onClick={()=>{setEditResumeId(resume._id); setTitle
                                    (resume.title)}} className='size-7 p-1.5 hover:bg-white/50 rounded
                                text-slate-700 transition-colors'/>
