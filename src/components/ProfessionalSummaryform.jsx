...
const ProfessionalSummaryform = ({data,onChange,setResumeData}) => {
  return (
    <div className='space-y-4'>
        ...
        focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a compelling professsional summary that highlights your
        key strengths and career objectives...'/>
        <p className='text-sm text-gray-500 max-w-4/5 mx-auto text-center'>Tip: Keep it concise (3-4 sentences) and focus on your most relevant
